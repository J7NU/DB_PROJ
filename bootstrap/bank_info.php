...
$sql = "SELECT BB_NAME, BB_ADDRESS, A.EMP_NAME, BB_BALANCE, COUNT(ACCOUNT.EMP_CODE)
FROM BANK_BRANCH JOIN EMPLOYEE A ON BANK_BRANCH.BB_MANAGER = A.EMP_CODE JOIN EMPLOYEE B ON BANK_BRANCH.BB_CODE = B.BB_CODE JOIN ACCOUNT ON B.EMP_CODE = ACCOUNT.EMP_CODE
GROUP BY BANK_BRANCH.BB_CODE";
...
<body>
        ...
        <div class="container">
            <div class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
                ...
                <ul class="nav nav-pills justify-content-end mb-md-0 fw-bold">
                    ...
                    <li><a href="bank_info.php" class="nav-link px-2 active">은행정보</a></li>
                </ul>
            </div>
        </div>
    </main>
            ...
            <div class="card mt-5">
                <div class="container">
                    <div class="card-header">
                        <h2 class="display-6 text-center">은행정보</h2>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody class="table-group-divider">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $result['BB_ADDRESS'] ?></td>
                                        <td><?php echo $result['EMP_NAME'] ?></td>
                                        <td><?php echo $result['BB_BALANCE'] ?></td>
                                        <td><?php echo $result['COUNT(ACCOUNT.EMP_CODE)'] ?></td>
                                    </tr>
                                <?php
                                }
                                ?>
    ...
    <script>
        ...
        function updateTable(result) {
            ...
            <td>${result[0]['BB_ADDRESS']}</td>
            <td>${result[0]['EMP_NAME']}</td>
            <td>${result[0]['BB_BALANCE']}</td>
            <td>${result[0]['COUNT(ACCOUNT.EMP_CODE)']}</td>
        `;
